...
# classification_p documentation build
...
from classification_p import __version__ as release

# -- Project information -----------------------------------------------------

project = "classification_p"
author = "Kedro"
...
htmlhelp_basename = "classification_pdoc"
...
latex_documents = [
    (
        master_doc,
        "classification_p.tex",
        "classification_p Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "classification_p",
        "Project classification_p codebase.",
        "Nearest-Neighbour",
    )
]
